...
public class DynamicPriceHistoryControllerTest {
    ...
    @Autowired
    public DynamicPriceHistoryControllerTest(MockMvc mockMvc) {

        this.mockMvc = mockMvc;
    }

    @Test
    public void testGetDynamicPriceHistoryRepositoryByCategoryEndpoit()
            throws Exception {
        ...
        mockMvc.perform(get("/rest/dynamic-price-history/category/lactate")
                ...
                .andExpect(
                        jsonPath("$[0].dataPoints[0].date").value("2025-05-01"))
                .andExpect(jsonPath("$[0].dataPoints[0].price").value(11.79))
                .andExpect(
                        jsonPath("$[0].dataPoints[1].date").value("2025-05-08"))
                ...
                .andExpect(
                        jsonPath("$[1].dataPoints[0].date").value("2025-05-01"))
                .andExpect(jsonPath("$[1].dataPoints[0].price").value(10.88))
                .andExpect(
                        jsonPath("$[1].dataPoints[1].date").value("2025-05-08"))
                .andExpect(jsonPath("$[1].dataPoints[1].price").value(11.61))
                .andExpect(
                        jsonPath("$[1].dataPoints[2].date").value("2025-05-15"))
                ...
                .andExpect(
                        jsonPath("$[2].dataPoints[0].date").value("2025-05-01"))
    ...
    @Test
    public void testGetDynamicPriceHistoryRepositoryByBrandEndpoit()
            throws Exception {
        ...
        mockMvc.perform(get("/rest/dynamic-price-history/brand/Pilos")
                ...
                .andExpect(
                        jsonPath("$[0].dataPoints[2].date").value("2025-05-15"))
